...
last_modified: 2026-03-12T23:19:34.000Z
...
| [Assign reserved keys to module and provider versions](#assign-reserved-keys-to-module-and-provider-version) | Lets team members assign reserved keys to module and provider versions in the private registry |
...
Enable this setting to allow team members to attach existing project tags to modules and providers in the registry. Use these tags to organize registry artifacts. Refer to [Manage projects](/terraform/cloud-docs/projects/manage) for more information.

### Assign reserved keys to module and provider versions

Enable this setting to allow team members to assign reserved tag keys to module and provider versions in the registry. The  **Registry environment tag** option must be enabled on the reserved tag keys to attach them to registry artifact versions. Refer to [Control access to registry artifacts](/terraform/cloud-docs/users-teams-organizations/organizations/manage-reserved-tags#control-access-to-registry-artifacts) for more information. 

These tags only apply to registry artifact versions, such as the specific version of a module or provider, projects, and workspaces. Refer to [Create and manage reserved tag keys](/terraform/cloud-docs/users-teams-organizations/organizations/manage-reserved-tags) for more information.

Use these tags to gate access to modules and providers based on tag. Refer to [Use artifacts from the registry](/terraform/cloud-docs/registry/using#find-artifacts) for more information.
