...
You can define tags stored as key-value pairs to help you organize your projects and track resource consumption. <!-- BEGIN: TFC:only name:reg-artifact-tags -->You can also attach project tags to modules and providers uploaded to the private registry. Workspaces in a project can only use artifacts that have the same tags as the project. Refer to [Manage artifact tags](/terraform/cloud-docs/registry/manage/tags) for more information.<!-- END: TFC:only name:reg-artifact-tags -->
